...
void draw_sky(t_point p1, t_point p2)
{
    ...
    while (i < p1.y)
    {
        ...
        while (j < p2.x)
        {
            ...
            set_color((unsigned char *)&game.img2->data[base + x_index], get_color(md.c->r, md.c->g, md.c->b));
            j++;
        }
        i++;
    }
...
void draw_land(t_point p1, t_point p2)
{
    ...
    while (i < height)
    {
        ...
        {
            x_index = get_calc_index(j, i);
            set_color((unsigned char *)&game.img2->data[base + x_index], get_color(md.f->r, md.f->g, md.f->b));
            j++;
        }
        i++;
    }
...
void draw_texture(t_point p1, t_point p2, t_ray ray)
{
    ...
    while (i < p2.y)
    {
        ...
        while (j < p2.x)
        {
            ...
            //set_color((unsigned char *)&game.img2->data[index + x_index], get_color(255, 255, 255));
            j++;
        }
        i++;
    }
